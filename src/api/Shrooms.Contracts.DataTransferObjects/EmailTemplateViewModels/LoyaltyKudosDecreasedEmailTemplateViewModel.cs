...
{
    public class LoyaltyKudosDecreasedEmailTemplateViewModel : BaseEmailTemplateViewModel
    {
        ...
        public LoyaltyKudosDecreasedEmailTemplateViewModel(string userNotificationSettingsUrl, decimal kudosAmount, string kudosType, string kudosSenderName, string comment, string kudosProfileUrl)
