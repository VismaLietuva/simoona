...
{
    public class LoyaltyKudosReceivedEmailTemplateViewModel : BaseEmailTemplateViewModel
    {
        ...
        public LoyaltyKudosReceivedEmailTemplateViewModel(string userNotificationSettingsUrl, decimal kudosAmount, string kudosType, string kudosSenderName, string comment, string kudosProfileUrl)
