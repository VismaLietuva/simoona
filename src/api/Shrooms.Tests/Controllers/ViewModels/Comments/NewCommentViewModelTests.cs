...
{
    [TestFixture]
    public class NewCommentViewModelTests
    {
        [Test]
        ...
        [Test]
        public void NewInstance_InvalidPostIdValue_ReturnsFalse()
        {
            // Arrange
            var viewModel = CreateValidViewModel();
        ...
        private NewCommentViewModel CreateValidViewModel()
        {
            return new NewCommentViewModel
            {
                MessageBody = "body",
                PostId = 1,
