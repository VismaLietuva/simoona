...
namespace Shrooms.Premium.EmailTemplates
{
    public class EmailPremiumTemplatesCompiler : IEmailTemplateCompiler
    {
        ...
        public void Register(string baseDir)
        {
            ...
            AddAndCompile(EmailPremiumTemplateCacheKeys.CoacheeJoinedEvent, @"EmailTemplates\Events\CoacheeJoinedEvent.cshtml", typeof(EventCoacheeToCoachJoinEmailTemplateViewModel));
            AddAndCompile(EmailPremiumTemplateCacheKeys.CoacheeLeftEvent, @"EmailTemplates\Events\CoacheeLeftEvent.cshtml", typeof(EventCoacheeToCoachLeaveEmailTemplateViewModel));
