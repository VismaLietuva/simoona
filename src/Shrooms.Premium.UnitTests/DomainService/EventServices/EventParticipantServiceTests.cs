    ...
    public class EventParticipantServiceTests
    {
        ...
        public void Should_Throw_When_Event_Not_Found()
        {
            ...
            _eventValidationServiceMock
                ...
                .Do(x => throw new EventException(EventDoesNotExistCode));

            Assert.Throws<EventException>(() => _eventParticipationService.UpdateSelectedOptions(dto), EventDoesNotExistCode);
        }
        ...
        public void Should_Throw_When_Registration_Deadline_Expired()
        {
            ...
            _eventValidationServiceMock
                ...
                .Do(x => throw new EventException(EventRegistrationDeadlineIsExpired));

            Assert.Throws<EventException>(() => _eventParticipationService.UpdateSelectedOptions(dto), EventRegistrationDeadlineIsExpired);
        }
        ...
        public void Should_Throw_When_Chosen_Options_Invalid()
        {
            ...
            Assert.Throws<EventException>(() => _eventParticipationService.UpdateSelectedOptions(dto), EventNoSuchOptionsCode);
        }
        ...
        public void Should_Throw_When_Not_Enough_Options_Chosen()
        {
            ...
            _eventValidationServiceMock
                ...
                .Do(x => throw new EventException(EventNotEnoughChoicesProvidedCode));

            Assert.Throws<EventException>(() => _eventParticipationService.UpdateSelectedOptions(dto), EventNotEnoughChoicesProvidedCode);
        }
        ...
        public void Should_Throw_When_Too_Many_Options_Chosen()
        {
            ...
            _eventValidationServiceMock
                ...
                .Do(x => throw new EventException(EventTooManyChoicesProvidedCode));

            Assert.Throws<EventException>(() => _eventParticipationService.UpdateSelectedOptions(dto), EventTooManyChoicesProvidedCode);
        }
        ...
        public void Should_Throw_When_Single_Join_Rule_Chosen_With_More_Options()
        {
            ...
            _eventValidationServiceMock
                ...
                .Do(x => throw new EventException(EventChoiceCanBeSingleOnly));

            Assert.Throws<EventException>(() => _eventParticipationService.UpdateSelectedOptions(dto), EventChoiceCanBeSingleOnly);
        }
        ...
        public void Should_Throw_When_User_Is_Not_Participating_In_Event()
        {
            ...
            _eventValidationServiceMock
                ...
                .Do(x => throw new EventException(EventUserNotParticipating));

            Assert.Throws<EventException>(() => _eventParticipationService.UpdateSelectedOptions(dto), EventUserNotParticipating);
        }
